// ---------------------------------------------------------------------
// SupplierOrderList.cs - FINAL (Date, Supplier, Total, Status Centered)
// ---------------------------------------------------------------------
using System;
...
namespace IT13
{
    public partial class SupplierOrderList : Form
    {
        ...
        public SupplierOrderList()
        {
            ...
            // ONLY THESE 4 LINES ADDED — CENTER ALIGNMENT
            dgvOrders.Columns["colDate"].DefaultCellStyle.Alignment     = DataGridViewContentAlignment.MiddleCenter;
            dgvOrders.Columns["colSupplier"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dgvOrders.Columns["colTotal"].DefaultCellStyle.Alignment    = DataGridViewContentAlignment.MiddleCenter;
