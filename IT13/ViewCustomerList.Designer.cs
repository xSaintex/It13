...
// READ-ONLY | Same Layout as Add/Edit | Title = TextBox
...
namespace IT13
{
    partial class ViewCustomerList
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitle = new Label(); txtTitle = new Guna2TextBox();  // ← TEXTBOX
            ...
            lblRequired.Text = "Fields marked with an asterisk (*) are required."; lblRequired.ForeColor = Color.Gray; lblRequired.Location = new Point(77, 56); lblRequired.AutoSize = true;
            ...
            btnBack.Text = "Back to List"; btnBack.Location = new Point(1330, 20); btnBack.Size = new Size(180, 40); btnBack.BorderRadius = 8;
