...
namespace IT13
{
    partial class AddRental
    {
        ...
        // Save Button
        private Guna2Button btnSaveRental;
        ...
        private void InitializeComponent()
        {
            ...
            // ===================== HEADER =====================
            lblHeader = new Label { Text = "New Rental", Font = new Font("Tahoma", 18F, FontStyle.Bold), Location = new Point(77, 20), AutoSize = true };
            ...
            txtCustomerName = new Guna2TextBox
            {
                Location = new Point(20, cy + 25),
                Size = new Size(420, 36),
                BorderRadius = 5,
                Font = new Font("Bahnschrift SemiCondensed", 10.5F),
            ...
            cmbBookingType = new Guna2ComboBox
            {
                Location = new Point(480, cy + 25),
            ...
            cmbPaymentTerms = new Guna2ComboBox
            {
                Location = new Point(820, cy + 25),
                Size = new Size(300, 36),
                BorderRadius = 5,
                Font = new Font("Bahnschrift SemiCondensed", 10.5F),
                ForeColor = Color.Black,
            ...
            dtpScheduledDate = new Guna2DateTimePicker
            {
                Location = new Point(20, cy + 25),
                Size = new Size(420, 36),
            ...
            dtpReturnDate = new Guna2DateTimePicker
            {
                Location = new Point(480, cy + 25),
                Size = new Size(300, 36),
                FillColor = Color.White,
            ...
            numServiceFee = new Guna2NumericUpDown
            {
                Location = new Point(1100, cy + 80),
                Size = new Size(100, 30),
                BorderRadius = 5,   
                Font = new Font("Bahnschrift SemiCondensed", 10.5F),
                ForeColor = Color.Black,
            ...
            numDiscount_Addr = new Guna2NumericUpDown
            {
                Location = new Point(1100, ty + 40),
                Size = new Size(100, 30),
                BorderRadius = 5,
                Font = new Font("Bahnschrift SemiCondensed", 10.5F),
                ForeColor = Color.Black,
            ...
            numServiceFee_Addr = new Guna2NumericUpDown
            {
                Location = new Point(1100, ty + 80),
                Size = new Size(100, 30),
                BorderRadius = 5,
                Font = new Font("Bahnschrift SemiCondensed", 10.5F),
                ForeColor = Color.Black,
            ...
            var btnSaveRentalAddr = new Guna2Button
            {
                Name = "btnSaveRental",
                Text = "Save Rental",
                Size = new Size(180, 48),
                Location = new Point(1386 - 180 - 40, ty + 200),
                FillColor = Color.FromArgb(0, 123, 255),
                ForeColor = Color.White,
                BorderRadius = 10,
                Font = new Font("Poppins", 11F, FontStyle.Bold),
