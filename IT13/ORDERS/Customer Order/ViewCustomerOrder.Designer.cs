...
namespace IT13
{
    partial class ViewCustomerOrder
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "This order is in read-only mode.";
            ...
            this.dateEstimated.Enabled = false;
            ...
            this.numShipping.Enabled = false;
            ...
            this.btnCancel.Location = new Point(1330, 20);
            this.btnCancel.Size = new Size(180, 40);
            this.btnCancel.BorderRadius = 8;
            this.btnCancel.ForeColor = Color.White;                    
            this.btnCancel.HoverState.FillColor = Color.FromArgb(200, 35, 51);

            this.btnSave.Visible = false; // Hidden in View mode
            ...
            this.bottomPanel.Controls.Add(this.btnCancel); // Only Close button

            // === FORM ===
            this.ClientSize = new Size(1914, 1055);
            this.Controls.Add(this.mainPanel);
            this.Text = "View Customer Order";
