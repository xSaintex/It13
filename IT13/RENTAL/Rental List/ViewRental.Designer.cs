...
namespace IT13
{
    partial class ViewRental
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                new DataGridViewTextBoxColumn { HeaderText = "PRODUCT NAME",    FillWeight = 40 },
                new DataGridViewTextBoxColumn { HeaderText = "QUANTITY",       FillWeight = 12 },
                new DataGridViewTextBoxColumn { HeaderText = "RENTAL PRICE",   FillWeight = 18 },
                new DataGridViewTextBoxColumn { HeaderText = "AVAILABLE QTY",  FillWeight = 15 },
                new DataGridViewTextBoxColumn { HeaderText = "SUBTOTAL",       FillWeight = 15 }
            });
            ...
            btnClose = new Guna2Button
            {
                ...
                FillColor = Color.FromArgb(80, 80, 90),
                ForeColor = Color.White,
                BorderRadius = 10,
                Font = new Font("Poppins", 11F, FontStyle.Bold)
            };
            btnClose.Parent = pnlRentalInfo;

            // ===================== ADDRESS PANEL (same layout) =====================
