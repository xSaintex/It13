...
namespace IT13
{
    partial class ViewCustomerList
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblRequired.Text = "Fields marked with an asterisk (*) are required."; lblRequired.Font = new Font("Tahoma", 9F); lblRequired.ForeColor = Color.Gray; lblRequired.Location = new Point(77, 56); lblRequired.AutoSize = true;
            lblNote.Text = "Note: Customer's Email and Phone number must be unique."; lblNote.Font = new Font("Tahoma", 9F); lblNote.ForeColor = Color.Gray; lblNote.Location = new Point(77, 80); lblNote.AutoSize = true;
            ...
            pnlAddress.Location = new Point(77, y + 50); pnlAddress.Size = new Size(1300, 520); pnlAddress.FillColor = Color.FromArgb(248, 249, 252);
            pnlAddress.ShadowColor = Color.FromArgb(100, 100, 100); pnlAddress.Radius = 20; pnlAddress.Visible = false;

            int leftX = 40, rightX = 760, fieldY = 70;

            lblBilling.Text = "Billing Address"; lblBilling.Font = new Font("Bahnschrift SemiCondensed", 12F, FontStyle.Bold); lblBilling.Location = new Point(leftX, 25); lblBilling.AutoSize = true;
            lblShip.Text = "Shipping Address"; lblShip.Font = new Font("Bahnschrift SemiCondensed", 12F, FontStyle.Bold); lblShip.Location = new Point(rightX, 25); lblShip.AutoSize = true;
            lnkCopy.Text = "Copy billing address"; lnkCopy.Font = new Font("Bahnschrift SemiCondensed", 9.5F); lnkCopy.Location = new Point(rightX, 25); lnkCopy.AutoSize = true; lnkCopy.LinkColor = Color.FromArgb(0, 123, 255);

            // Billing fields - Poppins + black text
