...
namespace IT13
{
    public partial class AddRental : Form
    {
        ...
        {
            MessageBox.Show("Rental has been created successfully!", "Success",
                MessageBoxButtons.OK, MessageBoxIcon.Information);

            GoBackToRentalList(); // Reuse same back logic
        }

        // THIS IS THE FIXED & BULLETPROOF BACK FUNCTION
        private void GoBackToRentalList()
        {
            // Find the main dashboard (Form1)
