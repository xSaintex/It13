// AddSupplierList.designer.cs – NOW 100% IDENTICAL TO AddCustomerList (Fonts + Black Text)
...
namespace IT13
{
    partial class AddSupplierList
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Basic Info — Poppins + Black text
            lblTitle.Text = "Title"; lblTitle.Font = new Font("Bahnschrift SemiCondensed", 10F); lblTitle.Location = new Point(77, y); lblTitle.AutoSize = true;
            txtTitle.Location = new Point(77, y + 25); txtTitle.Size = new Size(100, 36); txtTitle.BorderRadius = 5;
            txtTitle.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtTitle.ForeColor = Color.Black;

            lblFName.Text = "First Name *"; lblFName.Font = new Font("Bahnschrift SemiCondensed", 10F); lblFName.Location = new Point(197, y); lblFName.AutoSize = true;
            txtFName.Location = new Point(197, y + 25); txtFName.Size = new Size(300, 36); txtFName.BorderRadius = 5;
            txtFName.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtFName.ForeColor = Color.Black;

            lblLName.Text = "Last Name *"; lblLName.Font = new Font("Bahnschrift SemiCondensed", 10F); lblLName.Location = new Point(517, y); lblLName.AutoSize = true;
            txtLName.Location = new Point(517, y + 25); txtLName.Size = new Size(300, 36); txtLName.BorderRadius = 5;
            txtLName.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtLName.ForeColor = Color.Black;

            lblEmail.Text = "Email *"; lblEmail.Font = new Font("Bahnschrift SemiCondensed", 10F); lblEmail.Location = new Point(837, y); lblEmail.AutoSize = true;
            txtEmail.Location = new Point(837, y + 25); txtEmail.Size = new Size(500, 36); txtEmail.BorderRadius = 5;
            txtEmail.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtEmail.ForeColor = Color.Black;

            y += 80;

            lblCompany.Text = "Company Name"; lblCompany.Font = new Font("Bahnschrift SemiCondensed", 10F); lblCompany.Location = new Point(77, y); lblCompany.AutoSize = true;
            txtCompany.Location = new Point(77, y + 25); txtCompany.Size = new Size(600, 36); txtCompany.BorderRadius = 5;
            txtCompany.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtCompany.ForeColor = Color.Black;

            lblPhone.Text = "Phone number *"; lblPhone.Font = new Font("Bahnschrift SemiCondensed", 10F); lblPhone.Location = new Point(697, y); lblPhone.AutoSize = true;
            txtPhone.Location = new Point(697, y + 25); txtPhone.Size = new Size(300, 36); txtPhone.BorderRadius = 5;
            txtPhone.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtPhone.ForeColor = Color.Black;

            lblPayment.Text = "Payment Terms *"; lblPayment.Font = new Font("Bahnschrift SemiCondensed", 10F); lblPayment.Location = new Point(77, y + 80); lblPayment.AutoSize = true;
            cmbPayment.Location = new Point(77, y + 105); cmbPayment.Size = new Size(300, 36); cmbPayment.BorderRadius = 5;
            cmbPayment.Font = new Font("Bahnschrift SemiCondensed", 10.5F); cmbPayment.ForeColor = Color.Black;
            cmbPayment.Items.AddRange(new[] { "Cash", "Net 15", "Net 30", "Net 60" });

            lblStatus.Text = "Status"; lblStatus.Font = new Font("Bahnschrift SemiCondensed", 10F); lblStatus.Location = new Point(397, y + 80); lblStatus.AutoSize = true;
            cmbStatus.Location = new Point(397, y + 105); cmbStatus.Size = new Size(150, 36); cmbStatus.BorderRadius = 5;
            cmbStatus.Font = new Font("Bahnschrift SemiCondensed", 10.5F); cmbStatus.ForeColor = Color.Black;
            ...
            lblContactPerson.Text = "Contact Person *"; lblContactPerson.Font = new Font("Bahnschrift SemiCondensed", 10F); lblContactPerson.Location = new Point(40, 25); lblContactPerson.AutoSize = true;
            txtContactPerson.Location = new Point(40, 50); txtContactPerson.Size = new Size(600, 36); txtContactPerson.BorderRadius = 5;
            txtContactPerson.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtContactPerson.ForeColor = Color.Black;

            lblContactNum.Text = "Contact number *"; lblContactNum.Font = new Font("Bahnschrift SemiCondensed", 10F); lblContactNum.Location = new Point(40, 105); lblContactNum.AutoSize = true;
            txtContactNum.Location = new Point(40, 130); txtContactNum.Size = new Size(300, 36); txtContactNum.BorderRadius = 5;
            txtContactNum.Font = new Font("Bahnschrift SemiCondensed", 10.5F); txtContactNum.ForeColor = Color.Black;
            ...
            // Billing
            lblBCountry.Text = "Country *"; lblBCountry.Font = new Font("Bahnschrift SemiCondensed", 10F); lblBCountry.Location = new Point(lx, fy); lblBCountry.AutoSize = true;
            ...
            lblBCity.Text = "City *"; lblBCity.Font = new Font("Bahnschrift SemiCondensed", 10F); lblBCity.Location = new Point(lx, fy + 80); lblBCity.AutoSize = true;
            ...
            lblBZip.Text = "Zip Code *"; lblBZip.Font = new Font("Bahnschrift SemiCondensed", 10F); lblBZip.Location = new Point(lx, fy + 160); lblBZip.AutoSize = true;
            ...
            lblBLine1.Text = "Address Line 1 *"; lblBLine1.Font = new Font("Bahnschrift SemiCondensed", 10F); lblBLine1.Location = new Point(lx, fy + 240); lblBLine1.AutoSize = true;
            ...
            lblBLine2.Text = "Address Line 2"; lblBLine2.Font = new Font("Bahnschrift SemiCondensed", 10F); lblBLine2.Location = new Point(lx, fy + 320); lblBLine2.AutoSize = true;
            ...
            // Shipping
            lblSCountry.Text = "Country *"; lblSCountry.Font = new Font("Bahnschrift SemiCondensed", 10F); lblSCountry.Location = new Point(rx, fy); lblSCountry.AutoSize = true;
            ...
            lblSCity.Text = "City *"; lblSCity.Font = new Font("Bahnschrift SemiCondensed", 10F); lblSCity.Location = new Point(rx, fy + 80); lblSCity.AutoSize = true;
            ...
            lblSZip.Text = "Zip Code *"; lblSZip.Font = new Font("Bahnschrift SemiCondensed", 10F); lblSZip.Location = new Point(rx, fy + 160); lblSZip.AutoSize = true;
            ...
            lblSLine1.Text = "Address Line 1 *"; lblSLine1.Font = new Font("Bahnschrift SemiCondensed", 10F); lblSLine1.Location = new Point(rx, fy + 240); lblSLine1.AutoSize = true;
            ...
            lblSLine2.Text = "Address Line 2"; lblSLine2.Font = new Font("Bahnschrift SemiCondensed", 10F); lblSLine2.Location = new Point(rx, fy + 320); lblSLine2.AutoSize = true;
            ...
            // Bottom Buttons — Poppins Bold
            btnCancel.Text = "Cancel"; btnCancel.Font = new Font("Poppins", 10.5F, FontStyle.Bold);
            btnCancel.Location = new Point(1200, 20); btnCancel.Size = new Size(120, 40);
            btnCancel.FillColor = Color.FromArgb(220, 53, 69); btnCancel.ForeColor = Color.White; btnCancel.BorderRadius = 8;

            btnSave.Text = "Save Supplier"; btnSave.Font = new Font("Poppins", 10.5F, FontStyle.Bold);
            btnSave.Location = new Point(1330, 20); btnSave.Size = new Size(180, 40);
