...
namespace IT13
{
    partial class EditSupplierOrder
    {
        ...
        private void InitializeComponent()
        {
            ...
            // RE-ADDED: txtId and lblId (for code access)
            lblId = new Label();
            ...
            // HIDDEN: Order ID (for code only)
            lblId.Text = "Order ID:";
            lblId.Location = new Point(77, 5);
            lblId.Visible = false;
            txtId.Location = new Point(160, 2);
            txtId.Size = new Size(150, 36);
            txtId.ReadOnly = true;
            txtId.Visible = false;
            contentPanel.Controls.Add(lblId);
            ...
            cmbCompany.Location = new Point(40, y + 25); cmbCompany.Size = new Size(460, 36);
            lblOrderDate.Text = "Order Date *"; lblOrderDate.Location = new Point(520, y);
            dateOrder.Location = new Point(520, y + 25); dateOrder.Size = new Size(250, 36);
            dateOrder.FillColor = Color.White;
            lblPayment.Text = "Payment Terms *"; lblPayment.Location = new Point(40, y + 80);
            cmbPayment.Location = new Point(40, y + 105); cmbPayment.Size = new Size(460, 36);
            lblEstDate.Text = "Estimated Date *"; lblEstDate.Location = new Point(520, y + 80);
            dateEstimated.Location = new Point(520, y + 105); dateEstimated.Size = new Size(250, 36);
            dateEstimated.FillColor = Color.White;

            tabInfo.Controls.AddRange(new Control[] { lblCompany, cmbCompany, lblOrderDate, dateOrder, lblPayment, cmbPayment, lblEstDate, dateEstimated });
            ...
            btnSave.Text = "Update Supplier Order";
