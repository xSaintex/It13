...
namespace IT13
{
    partial class ViewCustomerList
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblRequired.Text = "Fields marked with an asterisk (*) are required."; lblRequired.Font = new Font("Poppins", 9F); lblRequired.ForeColor = Color.Gray; lblRequired.Location = new Point(77, 56); lblRequired.AutoSize = true;
            lblNote.Text = "Note: Customer's Email and Phone number must be unique."; lblNote.Font = new Font("Poppins", 9F); lblNote.ForeColor = Color.Gray; lblNote.Location = new Point(77, 80); lblNote.AutoSize = true;
            ...
            lblBilling.Text = "Billing Address"; lblBilling.Font = new Font("Poppins", 12F, FontStyle.Bold); lblBilling.Location = new Point(leftX, 25); lblBilling.AutoSize = true;
            lblShip.Text = "Shipping Address"; lblShip.Font = new Font("Poppins", 12F, FontStyle.Bold); lblShip.Location = new Point(rightX, 25); lblShip.AutoSize = true;
            lnkCopy.Text = "Copy billing address"; lnkCopy.Font = new Font("Poppins", 9.5F); lnkCopy.Location = new Point(rightX, 25); lnkCopy.AutoSize = true; lnkCopy.LinkColor = Color.FromArgb(0, 123, 255);
