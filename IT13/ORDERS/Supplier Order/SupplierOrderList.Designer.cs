...
namespace IT13
{
    partial class SupplierOrderList
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.colSupplier = new DataGridViewTextBoxColumn();
            ...
            this.dgvOrders.Columns.AddRange(new DataGridViewColumn[] {
                this.colID, this.colDate, this.colSupplier, this.colTotal, this.colStatus, this.colActions});
            // 
            // Export
            // 
            ...
            this.Export.BorderThickness = 1;
            this.Export.FillColor = Color.White;
            this.Export.ForeColor = Color.FromArgb(50, 50, 50);
            // 
            // btnAddOrder
            // 
            ...
            this.Filter.BorderThickness = 1;
            this.Filter.FillColor = Color.White;
            this.Filter.ForeColor = Color.FromArgb(50, 50, 50);
            // 
            // btnSearch
            // 
            ...
            this.txtSearch.PlaceholderText = "Search supplier or order ID...";
            ...
            this.Name = "SupplierOrderList";
            this.Text = "Supplier Order List";
