namespace IT13
{
    partial class AddCustOrder
    {
        ...
        private void InitializeComponent()
        {
            ...
            mainpanel.Controls.Add(guna2ShadowPanel2);
            ...
            dgvItems.ThemeStyle.AlternatingRowsStyle.ForeColor = SystemColors.ControlText;
            dgvItems.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.FromArgb(231, 229, 255);
            dgvItems.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.FromArgb(71, 69, 94);
            ...
            // SellingPrice
            // 
            SellingPrice.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            SellingPrice.HeaderText = "SELLING PRICE";
            SellingPrice.MinimumWidth = 6;
            SellingPrice.Name = "SellingPrice";
            SellingPrice.ReadOnly = true;
            SellingPrice.Width = 200;
            // 
            // AvailableQuantity
            // 
            AvailableQuantity.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            ...
            // txtboxdetail
            // 
            txtboxdetail.BorderRadius = 5;
            txtboxdetail.CustomizableEdges = customizableEdges19;
            txtboxdetail.DefaultText = "";
            txtboxdetail.DisabledState.BorderColor = Color.FromArgb(208, 208, 208);
            txtboxdetail.DisabledState.FillColor = Color.FromArgb(226, 226, 226);
            ...
            label2.TabIndex = 7;
            label2.Text = "Fields marked with an asterisk (*) are required.";
            // 
            // label1
            // 
