...
namespace IT13
{
    partial class SupplierReturns
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Same layout as CustomerReturns
            ...
            mainpanel.Controls.Add(btnAddReturn);
            ...
            colSupplierName.HeaderText = "Supplier Name"; colSupplierName.Name = "colSupplierName";
            ...
            {
                colCheck, colOrderID, colSupplierName, colQty, colTotal, colStatus, colReturnDate, colActions
            });
            ...
            btnAddReturn.Location = new Point(1202, 45); btnAddReturn.Size = new Size(190, 38);
            btnAddReturn.Text = "+ Add Return";
            btnAddReturn.FillColor = Color.FromArgb(0, 123, 255);
            btnAddReturn.ForeColor = Color.White;
            btnAddReturn.BorderRadius = 8;
            btnAddReturn.Font = new Font("Poppins", 10.5F, FontStyle.Bold);
            btnAddReturn.Click += btnAddReturn_Click;

            Filter.Location = new Point(1065, 45); Filter.Size = new Size(128, 50);
            ...
            txtSearch.PlaceholderText = "Search return ID, order ID or supplier name...";
            ...
            this.Name = "SupplierReturns";
            this.Text = "Supplier Returns";
        ...
        private DataGridViewTextBoxColumn colOrderID, colSupplierName, colQty, colTotal, colStatus, colReturnDate, colActions;
