...
namespace IT13
{
    public partial class EditSupplierReturns : Form
    {
        public EditSupplierReturns(object selectedReturn = null)
        {
            InitializeComponent();
            SetupControls();
            WireEvents();
        ...
        private void WireEvents()
        {
            ...
            btnSaveSupplierOrder.Click += (s, e) => UpdateSupplierReturn();
            btnSaveAddress.Click += (s, e) => UpdateSupplierReturn();
            btnSaveReturns.Click += (s, e) => UpdateSupplierReturn();
        ...
        private void LoadDataForEdit(object data = null)
        {
            ...
            txtReturnReason.Text = "10 units of Dell XPS 13 arrived with cracked screens.";
            txtBillingAddress.Text = "Unit 88, ABC Industrial Complex, Pasig City";
            txtShippingAddress.Text = "Same as billing address";

            CmbSupplierOrderID_SelectedIndexChanged(null, null);
        }
        ...
        private void UpdateSupplierReturn()
        {
            MessageBox.Show("Supplier Return has been updated successfully!", "Success",
