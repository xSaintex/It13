...
namespace IT13
{
    public partial class CustomerReturns : Form
    {
        ...
        public CustomerReturns()
        {
            ...
            // FINAL PERFECT COLUMN WIDTHS (AS YOU REQUESTED)
            ...
            dgvReturns.Columns["colTotal"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft; // Left-aligned
            ...
            dgvReturns.Columns["colActions"].FillWeight = 16;           // Perfect for two icons
